...
from .serializer import AssetSerializer,IdcSerializer,TagSerializer,BusinessUnitSerializer,TreeBusinessUnitSerializer
...
class TreeBusinessunitViewset(mixins.ListModelMixin,viewsets.GenericViewSet):
    queryset = BusinessUnit.objects.filter(parent_unit=None)
    serializer_class = TreeBusinessUnitSerializer
    permission_classes = [IsAuthenticated, ]
