...
class Assets(models.Model):
    ...
    wip = models.GenericIPAddressField(verbose_name=u'外网地址',blank=True,null=True,unique=True,error_messages={'unique':'该IP已存在，请不要重复添加', 'invalid': 'IP地址格式错误'})
    nip = models.GenericIPAddressField(verbose_name=u'内网地址',blank=True,null=True,unique=True,error_messages={'unique':'该IP已存在，请不要重复添加', 'invalid': 'IP地址格式错误'})
